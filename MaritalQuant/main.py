"""
MaritalQuant: Cross-border Asset Risk Simulator
...
st.set_page_config(
    page_title="MaritalQuant: Divorce Asset Risk Visualiser",
    page_icon="\u2696\ufe0f",
    layout="wide",
...
with st.sidebar:
    st.markdown("## \u2696\ufe0f MaritalQuant Settings")
...
<div class="dashboard-header">
    <div class="dashboard-title">\u2696\ufe0f MaritalQuant: Divorce Asset Risk Visualiser</div>
...
st.markdown("""
<div class="footer">
    MaritalQuant v0.4 \u00b7 Legal Tech Dashboard \u00b7
